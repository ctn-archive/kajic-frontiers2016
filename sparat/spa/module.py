...
from sparat.spa.exceptions import SpaModuleError
from nengo.network import Network
from nengo.params import IntParam
from sparat.spa.input import Input
from sparat.spa.vocab import VocabularyMap, VocabularyMapParam
...
class Module(nengo.Network, SupportDefaultsMixin):
    ...
    def similarity(self, data, probe, vocab=None):
        ...
        return sparat.spa.similarity(data[probe], vocab)
